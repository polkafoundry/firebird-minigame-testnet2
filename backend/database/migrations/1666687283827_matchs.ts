...
export default class Matchs extends BaseSchema {
  ...
  public async up() {
    this.schema.createTable(this.tableName, (table) => {
      ...
      table.integer('ou_ht_over').notNullable().defaultTo(0)
      table.integer('ou_ht_ratio').notNullable().defaultTo(0)
      table.integer('ou_ht_under').notNullable().defaultTo(0)
      table.integer('ou_ft_over').notNullable().defaultTo(0)
      table.integer('ou_ft_ratio').notNullable().defaultTo(0)
      table.integer('ou_ft_under').notNullable().defaultTo(0)
