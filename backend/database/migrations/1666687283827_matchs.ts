...
export default class Matchs extends BaseSchema {
  ...
  public async up() {
    this.schema.createTable(this.tableName, (table) => {
      ...
      table.integer('ou_ht_home').notNullable().defaultTo(0)
      table.integer('ou_ht_ratio').notNullable().defaultTo(0)
      table.integer('ou_ht_away').notNullable().defaultTo(0)
      table.integer('ou_ft_home').notNullable().defaultTo(0)
      table.integer('ou_ft_ratio').notNullable().defaultTo(0)
      table.integer('ou_ft_away').notNullable().defaultTo(0)
