...
const RewardBanner = (props: RewardBannerProps) => {
  ...
  return (
    <div className="mt-2 flex flex-col items-center">
      <div
        className={clsx(
          "flex flex-col xs:flex-row items-center font-tthoves border border-black",
          className,
        )}
      >
        <div className="w-[340px] flex flex-col items-center px-[70px] py-[14px] border-r-0 xs:border-r border-black">
          <span className="text-16/20 font-semibold uppercase">
            Total Reward
          </span>
          <span className="text-48/60 font-tthovesBold italic">{reward}</span>
        </div>
        <div className="w-[340px] flex flex-col items-center px-[70px] py-[14px] border-t border-black xs:border-t-0">
