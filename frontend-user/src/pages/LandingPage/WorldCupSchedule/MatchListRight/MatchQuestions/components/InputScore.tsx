...
const InputScore = (props: InputScoreProps) => {
  const InputNumber = (props: InputNumberProps) => {
    const { input, handleChange, className = "" } = props;
  ...
  return (
    <div className="flex space-x-5 items-baseline">
      <InputNumber input={inputTeam1} handleChange={handleChangeInputTeam1} />
      <span
        className={clsx(
      ...
      <InputNumber input={inputTeam2} handleChange={handleChangeInputTeam2} />
    </div>
  );
};
